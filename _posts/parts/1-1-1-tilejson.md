...
The URL of the tile above is `https://a.tiles.mapbox.com/v3/mapbox.world-light/2/2/1.png`.
...
<pre class='prettyprint'>
{
  "version": "1.0.0",
  "scheme": "xyz",
  "tiles" ["https://a.tiles.mapbox.com/v3/mapbox.world-light/{z}/{x}/{y}.png"]
}
</pre>
...
Some servers, like [MapBox Hosting](https://tiles.mapbox.com/) provide TileJSON
...
pulls a TileJSON description from a server using [JSONP](https://en.wikipedia.org/wiki/JSONP)
and gives it to you as an argument to a callback function that you can use to configure
your map.

Here we're using the url `https://api.tiles.mapbox.com/v3/mapbox.dc-nightvision.jsonp` for
the TileJSON for dc-nightvision - using the [MapBox Hosting API](https://mapbox.com/hosting/api/).

<pre class='prettyprint'>
var url = 'https://api.tiles.mapbox.com/v3/mapbox.dc-nightvision.jsonp';
